...
namespace KN_KAMPUS_MERDEKA.BUSSLOGIC.CustomBL.Systems
{
    public class mSystemConfigurationCustomBL
    {
        ...
        public static mSystemConfiguration parseFromJSON(JObject jsonDat)
        {
            mSystemConfiguration dat = new mSystemConfiguration();
            dat.intIndex = clsGlobal.ParseToInteger(jsonDat["intIndex"].ToString());
            dat.intModuleID = clsGlobal.ParseToInteger(jsonDat["intModuleID"].ToString());
            dat.txtDefaultValue = clsGlobal.ParseToString(jsonDat["txtDefaultValue"].ToString());
            dat.txtDescription = clsGlobal.ParseToString(jsonDat["txtDescription"].ToString());
            dat.txtKeyID = clsGlobal.ParseToString(jsonDat["txtKeyID"].ToString());
            dat.txtSystemConfigurationID = clsGlobal.ParseToString(jsonDat["txtSystemConfigurationID"].ToString());
            dat.txtValue = clsGlobal.ParseToString(jsonDat["txtValue"].ToString());
