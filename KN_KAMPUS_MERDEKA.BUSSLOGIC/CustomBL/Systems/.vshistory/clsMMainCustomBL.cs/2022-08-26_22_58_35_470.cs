...
namespace KN_KAMPUS_MERDEKA.BUSSLOGIC.CustomBL.Systems
{
    public static class clsMMainCustomBL
    {
        ...
        {
            return DateTime.Now.ToString("yyyyMMdd") + mSystemConfigurationCustomBL.GetmSystemConfigurationValue(clsMMainConstant.MODULE_NAME, clsMMainConstant.CONFIGURATION.Key.Generate_Random_Parameter, clsMMainConstant.CONFIGURATION.DefaultValue.DefaultLangID, dObjContext, dObjTran);
        }
