...
namespace KN_KAMPUS_MERDEKA.BUSSLOGIC.CustomBL.Systems
{
    ...
    {
        public static bool SendEmail(string txtBody, string txtEmailSender, string txtEmailSubject, string txtEmailTo, string txtJoinString, SFERPSEntities dObjContext, DbContextTransaction dObjTran)
        {
            try
            {
