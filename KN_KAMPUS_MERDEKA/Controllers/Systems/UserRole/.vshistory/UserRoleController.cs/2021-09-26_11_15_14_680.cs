...
using KN2021_E_RPS.Common.Dto.UserRole.Request;
using KN2021_E_RPS.Common.Dto.UserRole.Response;
...
namespace KN2021_E_RPS.MVC.Controllers
{
    public class UserRoleController : Controller
    {
        ...
        public ActionResult getAllByUser(int intUserId = 0, int page = 1, int size = 20, string cari = "")
        {
            try
            {
                Pageable<UserRoleResponse> pageResponse = mRoleAccessCustomBL.findAllByRole(intRoleId, page, size, cari);
