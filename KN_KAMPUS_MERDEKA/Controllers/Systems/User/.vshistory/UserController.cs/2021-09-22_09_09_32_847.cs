        ...
        public ActionResult Save(UserRegister userRegister)
        {
            try
            {
                ...
                if (mUserCustomBL.IsExistMUser(userRegister.intUserID) && userRegister.intUserID != 0)
                {
                    ...
                    savedUser.intUserID = userRegister.intUserID;
                    ...
                    //Update 
                    bitSuccess = mUserCustomBL.UpdateMUser(savedUser, GlobalClass.dLogin.userDat.intUserID.ToString(), GlobalClass.dLogin.txtLangID, user.txtGUID);
