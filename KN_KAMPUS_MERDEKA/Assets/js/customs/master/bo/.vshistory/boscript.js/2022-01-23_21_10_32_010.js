    ...
    if (pageBo.hasContent) {
        for (let i = 0; i < pageBo.content.length; i++) {
            ...
            let row = "<tr id='tr-" + idIntBo + "' class='tr-class'> " +
                "<td>" +m.txtBoNo + "</td>" +
                "<td>" + $.parseJsonDate(m.dtmPlanStartDate, true) + "</td>" +
                "<td>" + m.item.txtProduct + "</td>" +
                "<td>" + m.productionLine.txtProdLine + "</td>" +
                "<td>" + m.txtReceipeNumber + "</td>" +
                "<td>" + m.intReceipeVersion + "</td>" +
                "<td><span class='badge " + $badgeHold + "'>" + $badgeTextHold + "</span></td> " +
                "<td>" + $switcHold + "</td > " +
                "<td><span class='badge " + $badgePrioritas + "'>" + $badgeTextPrioritas + "</span></td> " +
