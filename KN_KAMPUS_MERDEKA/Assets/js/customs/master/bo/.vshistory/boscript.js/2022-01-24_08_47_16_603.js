        ...
        for (let i = 0; i < pageBo.content.length; i++) {
            ...
            let $switcHold = fullacces ?
                `<div class="form-group">
                                <label class="switch">
                                    <input type="checkbox" class="bitHold" id="bithold-`+ idIntBo + `" data-bo='` + JSON.stringify(m) + `' onClick="(function(e){ e.preventDefault(); setHold(e); })(event)">
            ...
            let $switcPrioritas = fullacces ?
                `<div class="form-group">
                                <label class="switch">
                                    <input type="checkbox" class="bitPrioritas" id="bitprioritas-`+ idIntBo + `" data-bo='` + JSON.stringify(m) + `' onClick="(function(e){ e.preventDefault(); setHold(e); })(event)">
                                    <span class="slider"></span>
                                </label>
