...
function setupDataProductVariantMetodeChangeOver() {
    productVariantMetodeChangeOver.intProductVariantMethodeChangeOverID = selectedProductionLine.intProductionLineID;
    productVariantMetodeChangeOver.intProductVariantIDFrom = selectedMaterialChangeOver.intMaterialChangeOverID;
    productVariantMetodeChangeOver.intProductVariantIDTo = selectedMetodeChageOver.intMetodeChangeOverID;
    productVariantMetodeChangeOver.intMetodeChangeOverID = parseInt($intQty.val().toString());
    productVariantMetodeChangeOver.intMetodeChangeOverID = parseFloat($decCostMaterial.val().toString());
    productVariantMetodeChangeOver.bitActive = parseFloat($decCostWaktu.val().toString());
}
//=======================
// ASSIGN EDIT PRODUCTION LINE CHANGE OVER DETAIL
//=======================
function setupDataProductVariantMetodeChangeOverEdit(r) {
    productVariantMetodeChangeOver.intProductVariantMethodeChangeOverID = selectedProductionLine.intProductVariantMethodeChangeOverID;
    productVariantMetodeChangeOver.intProductVariantIDFrom = selectedMaterialChangeOver.intProductVariantIDFrom;
    productVariantMetodeChangeOver.intProductVariantIDTo = selectedMetodeChageOver.intProductVariantIDTo;
    productVariantMetodeChangeOver.intMetodeChangeOverID = intMetodeChangeOverID;
    productVariantMetodeChangeOver.intMetodeChangeOverID = intMetodeChangeOverID;
    productVariantMetodeChangeOver.bitActive = intMetodeChangeOverID;
    //===========================
