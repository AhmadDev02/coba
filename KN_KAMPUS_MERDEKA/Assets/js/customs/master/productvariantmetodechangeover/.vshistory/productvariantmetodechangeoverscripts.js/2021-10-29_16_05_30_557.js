...
function setupDataProductVariantMetodeChangeOver() {
    productVariantMetodeChangeOver.intProductVariantIDFrom = parseInt(selectedProductVariantFrom.int);
    productVariantMetodeChangeOver.intProductVariantIDTo = parseInt(selectedProductVariantTo.intMetodeChangeOverID);
