...
function setupAddProductForm() {
    $txtProductName.val(product.txtProductName);
...
function setupDataProduct() {
    product.txtProductName = $txtProductName.val().toString();
...
function setupDataProductEdit(r) {
    ...
    product.txtProductName = r.txtProductName;
    product.txtDescription = r.txtDescription;
