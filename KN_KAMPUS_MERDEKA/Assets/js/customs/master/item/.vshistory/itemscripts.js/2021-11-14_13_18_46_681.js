    ...
    if (selectedAlergen == null) {
        ...
        if (selectedGramasi == null) {
            ...
            if (selectedSetupItem == null) {
                ...
                $.confirmMessageHtml(`Simpan Setup ${selectedSetupItem.txtItemDescription}`, `<br />
                                                ${selectedSetupItem.txtItemDescription} 
<br /> gramasi :  ${selectedGramasi.decGramasi} <br /> Alergen : ${selectedAlergen.txtAlergenCode} <br /> Revit ${itemSetup.intRevit}`, 'Ya Saya Yakin', () => {
