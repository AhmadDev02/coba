...
function fillTableData() {
    ...
    if (pageItem.hasContent) {
        ...
        $(".btn-setup").on('click', function () {
            ...
            setupItemForm();
            $setupTitle.html(`Setup Item <span class='text-green text-bold blink'>${r.txtItemDescription}</span>`);
        })
...
$btnSelectGramasi.bind('click', () => {
    ...
    productSearchFilter = productSearchFilter[0] + " " + productSearchFilter[1]
