...
let elementToSwitch = [$("#itemFormRow"), $("#itemTableRow")];
let $itemFormTitle = $("#itemFormTitle");
...
let $btnCancelAddItem = $("#btnCancelAddItem");
//=======================
// FORM 
//=======================
let $txtItemCode = $("#txtItemCode");
let $txtItemDescription = $("#txtItemDescription");
...
function saveItem() {
    $.postApi(api + "/Save",
        ...
        function (response) {
            ...
            $.successMessage("Sukses", "Berhasil menyimpan item");
            getAllItem(0, cari)
        },
        function (e) {
            $.errorMessage("Failed", e.responseJSON.txtMessage);
...
function fillTableData() {
    ...
    if (pageItem.hasContent) {
        ...
        $(".btnEdit").on('click', function () {
            ...
            setupDataItemEdit(r);
            setupDataItemEditForm();
            $.switchElement(elementToSwitch, 0);
            $itemFormTitle.text = "Edit Items";
        })
