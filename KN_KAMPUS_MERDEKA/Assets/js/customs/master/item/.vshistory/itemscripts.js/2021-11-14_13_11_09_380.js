    ...
    if (selectedAlergen == null) {
        ...
        if (selectedGramasi == null) {
            ...
            if (selectedSetupItem == null) {
                ...
                $.confirmMessage('Simpan', `apakah yakin akan simpan ${selectedSetupItem.txtItemDescription} dengan <br /> gramasi :  ${selectedGramasi.decGramasi} <br /> Alergen : ${selectedAlergen.txtAlergenCode} <br /> Revit ${itemSetup.intRevit}`, 'Ya Saya Yakin', () => {
