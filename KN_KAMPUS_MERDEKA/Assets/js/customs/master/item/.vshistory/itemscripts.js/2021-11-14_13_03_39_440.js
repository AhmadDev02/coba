    ...
    if (selectedAlergen == null) {
        ...
        if (selectedGramasi == null) {
            ...
            if (selectedSetupItem == null) {
                ...
                $.confimMessage('Simpan', `apakah yakin akan simpan ${selectedSetupItem.txtItemDescription} dengan <br /> gramasi :  ${selectedGramasi.decGramasi} <br /> Alergen : ${selectedAlergen.txtAlergenCode}`)
            }
        }
    }
});
