...
let elementToSwitch = [$("#itemTableRow"), $("#setupRow")];
//=======================
// ALL BUTTON
//=======================
let $btnPrev = $("#btnPrev");
...
function fillTableData() {
    ...
    if (pageItem.hasContent) {
        for (let i = 0; i < pageItem.content.length; i++) {
            ...
            let $btnSetup = !m.bitSetup ? `<button class=' btn btn-outline-warning btn-setup' data-item='` + JSON.stringify(m) + `'> <i class='fa fa-edit'></i> Edit</button>`;
