...
function fillTableData() {
    ...
    if (pageProductVariantAuger.hasContent) {
        for (let i = 0; i < pageProductVariantAuger.content.length; i++) {
            ...
            let $btnGramasi = `<button class=' btn btn-outline-warning btnGramasi m-1' data-productvariantauger='` + JSON.stringify(m) + `'> <i class='fa fa-balance-scale'></i> Gramasi</button>`;
