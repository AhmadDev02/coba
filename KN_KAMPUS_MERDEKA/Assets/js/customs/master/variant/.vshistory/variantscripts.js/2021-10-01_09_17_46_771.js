...
function setupAddVariantForm() {
    $txtSelectedVariantCategoryDescription = variant.txtSelectedVariantCategoryDescription;
    $txtVariantCode = variant.txtVariantCode;
    $txtVariantDescription = variant.txtVariantDescription;
    $intLevel = variant.intLevel;
}
...
function setupDataVariant() {
    variant.txtSelectedVariantCategoryDescription = $txtSelectedVariantCategoryDescription = $("#txtSelectedVariantCategoryDescription");
    variant.txtVariantCode = $("#txtVariantCode");
    variant.txtVariantDescription = $("#txtVariantDescription");
    variant.intLevel = $("#intLevel");
}
//=======================
// ASSIGN EDIT VARIANT
//=======================
