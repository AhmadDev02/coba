    ...
    if (pageGramasi.hasContent) {
        for (let i = 0; i < pageGramasi.content.length; i++) {
            ...
            let row = "<tr id='intGramasiID" + m.intProductVariantAugerGramasiID + "'>" +
                ...
                "<td class='text-center'>" + m.decGramasi + "<span class='text-success text-bold'> G</span></td>" +
                "<td class='text-center'>" + m.txtProductVariantDescription "<span class='text-danger'>" + m.intAugerSize + "</span>" + " " + m.decGramasi + "G" + "</td>" +
...
function setupDataGramasi() {
    ...
    gramasi.intProductVariantAugerID = parseFloat($("#intProductVariantAugerID").val().toString());
}
//=======================
// ASSIGN EDIT PRODUCT
//=======================
