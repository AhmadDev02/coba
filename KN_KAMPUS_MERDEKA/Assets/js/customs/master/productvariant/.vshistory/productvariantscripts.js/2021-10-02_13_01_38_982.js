...
function getSelectedProduct(x) {
    ...
    if (selectedVariant != null) {
        $txtProductVariantCode.val(x.txtProductCode + selectedVariant.txtVariantCode)
        $txtProductVariantCode.val(x.txtProductDescription + "" + selectedVariant.txtVariantDescription)
    } else {
        $txtProductVariantCode.val(x.txtProductDescription)
    }
