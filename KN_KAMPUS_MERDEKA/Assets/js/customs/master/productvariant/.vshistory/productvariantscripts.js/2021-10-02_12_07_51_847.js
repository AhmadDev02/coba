...
let elementToSwitch = [$("#productVariant FormRow"), $("#productVariant TableRow")];
let $productVariantFormTitle = $("#productVariant FormTitle");
...
function setupAddVariantForm() {
    $txtSelectedVariantCategoryDescription.val(productVariant .txtSelectedVariantCategoryDescription);
