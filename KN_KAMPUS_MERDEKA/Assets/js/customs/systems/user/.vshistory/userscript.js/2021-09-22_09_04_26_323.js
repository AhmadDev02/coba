...
function setupDataUserEditForm() {
    user.txtUserName = $txtUsername.val(user.txtUserName);
    user.txtFullName = $txtFullname.val(user.txtFullName);
    user.txtNick = $txtNick.val(user.txtNick);
    user.txtEmpID = $txtEmployeeID.val(user.txtEmpID);
    user.txtEmail = $txtEmail.val(user.txtEmail);
    user.txtPassword = $txtPassword.val(user.txtPassword);
    $bitActive.prop('checked', user.bitActive);
    $bitUseActiveDirectory.prop('checked', user.bitUseActiveDirectory);
}
