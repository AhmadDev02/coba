...
function setupDataUser() {
    ...
    user.txtUserName = $txtFullname.val().toString();
    user.txtUserName = $txtNick.val().toString();
    user.txtUserName = $txtEmployeeID.val().toString();
    user.txtUserName = $txtEmail.val().toString();
    user.txtPassword = $txtPassword.val().toString();
    user.bitActive = $bitActive.is(":checked");
    user.bitUseActiveDirectory = $bitActive.is(":checked");
