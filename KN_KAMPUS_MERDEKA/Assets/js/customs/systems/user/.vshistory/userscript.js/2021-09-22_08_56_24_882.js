...
function fillTableData() {
    ...
    if (pageUser.hasContent) {
        for (let i = 0; i < pageUser.content.length; i++) {
            ...
            let $btnEdit = "<button class='btnEdit  btn btn-outline-danger float-right m-1' data-user='" + JSON.stringify(udata) + "'> <i class='fa fa-chevron-down'></i> Cancel</button>";
        ...
        $(".btnEdit").on('click', function() {
            console.log(JSON.stringify($(this).data('u')))
        })
