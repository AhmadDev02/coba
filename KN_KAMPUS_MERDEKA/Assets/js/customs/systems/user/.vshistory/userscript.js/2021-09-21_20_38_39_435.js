...
let $bitActiveDirectory = $("#bitActiveDirectory");
...
function setupAddUserForm() {
    $bitActive.prop("checked", user.bitActive | true);
    $bitUseActiveDirectory.prop("checked", user.bitUseActiveDirectory | false);
}
