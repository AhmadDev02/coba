...
function fillTableData() {
    ...
    if (pageUser.hasContent) {
        for (let i = 0; i < pageUser.content.length; i++) {
            ...
            let $btnUserRole = `<button class='btnUserRole  btn btn-outline-success float-right m-1' data-user='` + JSON.stringify(r) + `'> <i class='fa fa-keys'></i> Access</button>`;
