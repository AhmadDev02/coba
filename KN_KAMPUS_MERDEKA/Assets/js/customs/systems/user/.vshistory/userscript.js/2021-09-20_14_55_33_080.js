...
function fillTableData() {
    ...
    if (pageUser.hasContent) {
        for (let i = 0; i < pageUser.content.length; i++) {
            ...
            let row = "<tr id='idUser" +  + "'>" +
                "<td class='text-center'>" + response.content[i].bano.kode + "</td>" +
                "<td class='text-center'>" + response.content[i].bano.nama + "</td>" +
                "<td class='text-center'>" + response.content[i].bano.jenis + "</td>" +
                "<td class='text-center'>" + response.content[i].qty + "</td>" +
                "<td class='text-center'>" + response.content[i].bano.satuan + "</td>" +
