...
function fillTableData() {
    ...
    if (pageMaterialChangeOver.hasContent) {
        for (let i = 0; i < pageMaterialChangeOver.content.length; i++) {
            ...
            let $btnSelect = `<button class=' btn btn-outline-success btnSelect ' data-materialchangeover='` + JSON.stringify(m) + `'> <i class='fa fa-check'></i> Select</button>`;
        ...
        $(".btnSelect").on('click', function () {
            selectData($(this).data('materialchangeover'));
        })
