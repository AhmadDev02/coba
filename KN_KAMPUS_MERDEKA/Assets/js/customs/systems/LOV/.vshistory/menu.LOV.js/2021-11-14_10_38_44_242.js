...
function fillTableData() {
    ...
    if (pageMenu.hasContent) {
        for (let i = 0; i < pageMenu.content.length; i++) {
            ...
            let $btnSelect = `<button class=' btn btn-outline-success btnSelect ' data-menu='` + JSON.stringify(m) + `'> <i class='fa fa-check'></i> Select</button>`;
...
function selectData(data) {
    parent.getSelectedMenu(data); // pass it to parent page
