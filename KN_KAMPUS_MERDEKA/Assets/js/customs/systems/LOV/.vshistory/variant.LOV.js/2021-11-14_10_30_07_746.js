...
function fillTableData() {
    ...
    if (pageVariant.hasContent) {
        for (let i = 0; i < pageVariant.content.length; i++) {
            ...
            let $btnSelect = `<button class=' btn btn-outline-success btnSelect' data-variant='` + JSON.stringify(m) + `'> <i class='fa fa-check'></i> Select</button>`;
