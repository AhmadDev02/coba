...
let api = "/Master/ProductVariantAugerGramasi";
    ...
    if (pageProductVariantAugerGramasi.hasContent) {
        for (let i = 0; i < pageProductVariantAugerGramasi.content.length; i++) {
            ...
            let row = "<tr id='intProductVariantAugerGramasiID" + m.intProductVariantAugerGramasiID + "'>" +
                ...
                "<td class='text-center'>" + m.txtProductVariantAugerGramasiCode + "</td>" +
                "<td class='text-center'>" + m.txtProductVariantAugerGramasiDescription + "</td>" +
                "</tr>";
            $("#tbodyLOV").append(row);
        }
