...
let $colRole = $("#colRole");
let $roleAccessTitleForm = $("#roleAccessTitleForm");
//=======================
// ALL BUTTON
//=======================
let $btnPrev = $("#btnPrev");
...
let $btnCloseRoleAccess = $("#btnCloseRoleAccess");
//=======================
// FORM ROLE
//=======================
...
//=======================
function getAllRole(w,x, y,z) {
    $.postApi(apiRoleAccess + "/findAllByRole",
        {
            page: x,
            cari: y,
            size: 20
