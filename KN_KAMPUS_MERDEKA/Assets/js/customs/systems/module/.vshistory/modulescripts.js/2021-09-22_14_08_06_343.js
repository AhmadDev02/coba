...
function fillTableData() {
    ...
    if (pageModule.hasContent) {
        for (let i = 0; i < pageModule.content.length; i++) {
            ...
            let $btnEdit = `<button class='btnEdit  btn btn-outline-warning float-right m-1' data-module='` + JSON.stringify(m) + `'> <i class='fa fa-edit'></i> Edit</button>`;
...
function setupDataModuleEditForm() {
    $txtModuleName.val(module.txtModuleName);
    $txtDescription.val(module.txtModuleName);
}
