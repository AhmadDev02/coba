...
function setupDataMenu() {
    ...
    menu.intParentID = selectedParentMenu.intMenuID ? selectedParentMenu.intMenuID : 0;
...
function setupDataMenuEditForm() {
    ...
    $bitActive.val(menu.bitActive);
    $txtLink.val(menu.txtLink);
    $txtSelectedModuleName.val(selectedModule.txtModuleName | "Select Module");
    $txtSelectedParentName.val(selectedParentMenu.txtMenuName | "Select Parent");
    $bitActive.prop("chcked", menu.bitActive);
}
/*================================
GET SELECTED MODULE
================================== */
