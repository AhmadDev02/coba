...
let apiUserRole = "/Systems/UserRole";
...
$btnAddUserRole.bind('click', () => {
    ...
    $userRoleFormTitle.text(userSelected.txtUserName);
    iniitializeDataUserRole();
})
...
$btnClearSelectRole.bind('click', () => {
    selectedRole = {};
    selectedRole.intRoleID = 0;
    selectedRole.txtRoleName = "Select Parent Menu";
    $txtSelectedRoleName.val(selectedRole.txtRoleName);
})